...
const TEXINFO* CMultiTexture::Get_Texture(const wstring& pStateKey,const int iCnt)
{
...
HRESULT CMultiTexture::Insert_Texture(const wstring& pFilePath, const wstring& pStateKey, const int iCnt)
{
    ...
    {
        swprintf_s(szFullPath, pFilePath.c_str(), i);
